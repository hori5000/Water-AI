...
| History 조회 구성 | **확정(2024 백업)** | `HistdataViewstr → HistData/ViewStream1` 13 Point + `aaHistClient*` ActiveX |
...
- 2024 InTouch에서도 `211.120\VIEW` Primary / `212.120\VIEW` Secondary가 직접 확인되어 **211/212 이중 네트워크가 실제 운용 구조에 포함된 것은 더 강하게 확인됐다.**
