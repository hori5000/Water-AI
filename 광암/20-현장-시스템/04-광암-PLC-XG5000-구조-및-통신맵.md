...
## 2026-09-09 HMI 최신본과 XG5000 후보 대조

2026-06-22 현재 GFENet Source에는 기존 13개 주요 Topic 외에 다음이 추가돼 있다.

```text
P52, P56, PLC3, P16, PLC10
```
...
```text
P16   → 침전지/여과지 잔류염소
PLC10 → 혼화지/침전지 pH·알카리도 + 조류 측정
```

또 P21/P22에 AI 연계 Point가 실제 추가됐다.
...
이는 P21/P22 AI 연계 작업과 시간상/설비상 강하게 대응하지만, **현재 PLC 다운로드본 확정은 Online Compare가 필요하다.**

다음 작업은 15,153개 HMI/DDE 통합매핑의 `DDE_ItemName(MW...)`을 XG5000 Symbol/Program에 연결하는 것이다.
