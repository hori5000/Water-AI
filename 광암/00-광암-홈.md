...
- **다음 작업 1순위(데이터 확보)**: POS11 Historian에서 AI 대상 Tag를 대상으로 **최소 1년 이상의 `Timestamp / TagName / Value / Quality` Export**를 수행하거나 실제 History Storage를 인수. 구조 분석은 병행하여 `DDE Item(MW주소) ↔ XG5000 Symbol/Comment/Program Block` JOIN을 진행
