...
| Tag 기준 | [[../30-데이터-분석/04-M203-Signal-Master-v0.9|M203 Signal Master v0.9]] |
...
Collector 자체 설정은 `M203 Signal Master`에서 생성 가능한 구조를 우선한다. 주소를 코드 안에 하드코딩해 별도 정본을 만들지 않는다.
